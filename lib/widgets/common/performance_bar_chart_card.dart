...
/// 性能指标柱状图卡片小组件
///
/// 用于展示增长数据和柱状图统计的卡片组件，支持动画效果和主题适配。
/// 适用于展示性能指标、增长趋势、统计数据等场景。
///
/// 使用示例：
/// ```dart
...
///   barData: [
///     BarChartData(value: 12, label: '12%'),
///     BarChartData(value: 78, label: '78%'),
///     BarChartData(value: 62, label: '62%'),
///     BarChartData(value: 70, label: '70%'),
///     BarChartData(value: 75, label: '75%'),
///     BarChartData(value: 95, label: '95%'),
///   ],
///   footerLabel: 'See All',
/// )
/// ```
class PerformanceBarChartCard extends StatefulWidget {
  /// 顶部徽章标签
  ...
  @override
  State<PerformanceBarChartCard> createState() => _PerformanceBarChartCardState();
}

class _PerformanceBarChartCardState extends State<PerformanceBarChartCard>
