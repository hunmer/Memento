...
class WidgetLocalizations {
  const WidgetLocalizations(this.locale);
...
class _WidgetLocalizationsDelegate
    extends LocalizationsDelegate<WidgetLocalizations> {
  const _WidgetLocalizationsDelegate();
  ...
  @override
  Future<WidgetLocalizations> load(Locale locale) async {
    return WidgetLocalizations(locale);
  }

  @override
  bool shouldReload(LocalizationsDelegate<WidgetLocalizations> old) => false;
}