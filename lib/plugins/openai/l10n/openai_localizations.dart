...
abstract class OpenAILocalizations {
  static OpenAILocalizations of(BuildContext context) {
    final localizations = Localizations.of<OpenAILocalizations>(context, OpenAILocalizations);
  ...
  static OpenAILocalizations get defaultLocalizations => OpenAILocalizationsZh();
...
class OpenAILocalizationsZh implements OpenAILocalizations {
  ...
  @override
  String get defaultSystemPrompt => '你是一个乐于助人的AI助手，擅长回答问题并提供有用的建议。请用友好的语气与用户交流。';
...
class OpenAILocalizationsEn implements OpenAILocalizations {
  ...
  @override
  String get pluginDescription => 'AI assistant plugin supporting multiple LLM providers';
  ...
  @override
  String get defaultAgentDescription => 'A friendly AI assistant that can help answer various questions and complete various tasks.';
  
  @override
  String get defaultSystemPrompt => 'You are a helpful AI assistant who excels at answering questions and providing useful suggestions. Please communicate with users in a friendly tone.';
  ...
  @override
  String get updateConfigConfirm => 'Do you want to update the current settings with this provider\'s default configuration?';
  ...
  @override
  String get deleteAgentMessage => 'Are you sure you want to delete this agent? This action cannot be undone.';
  ...
  @override
  String get confirmDeleteModel => 'Are you sure you want to delete model {modelName}?';
