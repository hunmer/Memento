  ...
  static void register() {
    ...
    registry.register(
      HomeWidget(
        ...
        builder: (context, config) {
          ...
          return _PointsGoalProgressWidget(config: dataMap);
        },
      ),
    );
    ...
    registry.register(
      HomeWidget(
        ...
        builder: (context, config) {
          final dataMap = config['selectedData'] as Map<String, dynamic>? ?? {};
          return _ProductSelectorWidget(config: dataMap);
        },
      ),
    );
    ...
    registry.register(
      HomeWidget(
        ...
        builder: (context, config) {
          final dataMap = config['selectedData'] as Map<String, dynamic>? ?? {};
          return _UserItemSelectorWidget(config: dataMap);
        },
      ),
    );
  }
...
// ===== StatefulWidget 组件（使用事件携带数据模式）=====

/// 积分目标进度小组件 - 使用事件携带数据模式
class _PointsGoalProgressWidget extends StatefulWidget {
...
class _ProductSelectorWidget extends StatefulWidget {
  ...
  const _ProductSelectorWidget({required this.config});
...
class _UserItemSelectorWidget extends StatefulWidget {
  final Map<String, dynamic> config;
