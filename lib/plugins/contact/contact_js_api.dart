...
Future<String> _jsGetContacts(Map<String, dynamic> params) async {
  try {
    ...
    final result = await ContactPlugin.instance._useCase.getContacts(params);
    ...
    if (getHttpImage && contacts.isNotEmpty) {
      contacts = await LocalHttpServer.convertImagesWithAutoConfig(
        ...
        imageKey: 'avatar',
        storageManager: ContactPlugin.instance.storage,
      );
    }
...
Future<String> _jsGetContact(Map<String, dynamic> params) async {
  ...
  final result = await ContactPlugin.instance._useCase.getContactById({'id': contactId});
...
Future<String> _jsCreateContact(Map<String, dynamic> params) async {
  final result = await ContactPlugin.instance._useCase.createContact(params);
...
Future<String> _jsUpdateContact(Map<String, dynamic> params) async {
  ...
  final result = await ContactPlugin.instance._useCase.updateContact(useCaseParams);
...
Future<String> _jsDeleteContact(Map<String, dynamic> params) async {
  ...
  final result = await ContactPlugin.instance._useCase.deleteContact({'id': contactId});
...
Future<String> _jsAddInteraction(Map<String, dynamic> params) async {
  final result = await ContactPlugin.instance._useCase.createInteractionRecord(params);
...
Future<String> _jsGetInteractions(Map<String, dynamic> params) async {
  final result = await ContactPlugin.instance._useCase.getInteractionRecords(params);
...
Future<String> _jsDeleteInteraction(Map<String, dynamic> params) async {
  ...
  final result = await ContactPlugin.instance._useCase.deleteInteractionRecord({
    'id': interactionId,
  });
...
Future<String> _jsGetRecentContacts(Map<String, dynamic> params) async {
  final result = await ContactPlugin.instance._useCase.getRecentlyContactedCount(params);
...
Future<String> _jsGetAllTags(Map<String, dynamic> params) async {
  final result = await ContactPlugin.instance._useCase.getAllTags(params);
...
Future<String> _jsFindContactBy(Map<String, dynamic> params) async {
  try {
    ...
    final result = await ContactPlugin.instance._useCase.searchContacts(searchParams);
...
Future<String> _jsFindContactById(Map<String, dynamic> params) async {
  try {
    ...
    final result = await ContactPlugin.instance._useCase.getContactById({'id': id});
...
Future<String> _jsFindInteractionBy(Map<String, dynamic> params) async {
  try {
    ...
    if (field == 'contactId' && value is String) {
      ...
      final result = await ContactPlugin.instance._useCase.searchInteractionRecords(searchParams);
    ...
    // 其他字段查找需要先获取所有记录再筛选
    final interactions = await ContactPlugin.instance._controller.getAllInteractions();
...
Future<String> _jsFindInteractionById(Map<String, dynamic> params) async {
  try {
    ...
    final result = await ContactPlugin.instance._useCase.getInteractionRecordById({'id': id});
