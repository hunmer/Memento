...
class AppStoreManager extends ChangeNotifier {
  ...
  Future<void> _addDefaultSource() async {
    final localSource = AppStoreSource(
      id: const Uuid().v4(),
      name: '本地开发仓库',
      url: 'http://127.0.0.1:8899/apps/apps.json',
      baseUrl: 'http://127.0.0.1:8899/apps',
    ...
    final defaultSource = AppStoreSource(
      ...
      name: '网络仓库',
      url:
          'https://gitee.com/neysummer2000/memento/raw/master/online/apps/apps.json',
      baseUrl: 'https://gitee.com/neysummer2000/memento/raw/master/online/apps',
      isDefault: true,
      createdAt: DateTime.now(),
    );
