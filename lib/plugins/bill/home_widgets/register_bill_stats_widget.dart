  ...
  registry.register(
    HomeWidget(
      ...
      builder: (context, config) {
        return _BillStatsLiveSelectorWidget(
...
class _BillStatsLiveSelectorWidget extends LiveSelectorWidget {
  const _BillStatsLiveSelectorWidget({
  ...
  Future<Map<String, dynamic>> getLiveData(Map<String, dynamic> config) {
    return provideBillStatsWidgets(config);
  }

  @override
  String get widgetTag => 'BillStatsWidget';
