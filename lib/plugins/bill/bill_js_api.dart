...
Future<String> _jsGetAccounts(Map<String, dynamic> params) async {
  final result = await BillPlugin.instance._billUseCase.getAccounts(params);
...
Future<String> _jsCreateAccount(Map<String, dynamic> params) async {
  final result = await BillPlugin.instance._billUseCase.createAccount(params);
...
Future<String> _jsUpdateAccount(Map<String, dynamic> params) async {
  final result = await BillPlugin.instance._billUseCase.updateAccount(params);
...
Future<String> _jsDeleteAccount(Map<String, dynamic> params) async {
  final result = await BillPlugin.instance._billUseCase.deleteAccount(params);
...
Future<String> _jsGetBills(Map<String, dynamic> params) async {
  final result = await BillPlugin.instance._billUseCase.getBills(params);
...
Future<String> _jsCreateBill(Map<String, dynamic> params) async {
  final result = await BillPlugin.instance._billUseCase.createBill(params);
...
Future<String> _jsUpdateBill(Map<String, dynamic> params) async {
  final result = await BillPlugin.instance._billUseCase.updateBill(params);
...
Future<String> _jsDeleteBill(Map<String, dynamic> params) async {
  final result = await BillPlugin.instance._billUseCase.deleteBill(params);
...
Future<String> _jsGetStats(Map<String, dynamic> params) async {
  final result = await BillPlugin.instance._billUseCase.getStats(params);
  ...
  return jsonEncode({
    ...
    'todayFinance': BillPlugin.instance.controller.getTodayFinance(),
    'monthFinance': BillPlugin.instance.controller.getMonthFinance(),
    'monthBillCount': BillPlugin.instance.controller.getMonthBillCount(),
  });
}
...
Future<String> _jsGetCategoryStats(Map<String, dynamic> params) async {
  final result = await BillPlugin.instance._billUseCase.getCategoryStats(params);
...
Future<String> _jsFindAccountBy(Map<String, dynamic> params) async {
  ...
  final accounts = BillPlugin.instance.controller.accounts;
...
Future<String> _jsFindAccountById(Map<String, dynamic> params) async {
  ...
  final account = BillPlugin.instance.controller.accounts.firstWhere(
    (a) => a.id == id,
    orElse:
        () => Account(
      id: '',
...
Future<String> _jsFindBillBy(Map<String, dynamic> params) async {
  ...
  // 获取所有账单
  final allBills = await BillPlugin.instance.controller.getBills();
