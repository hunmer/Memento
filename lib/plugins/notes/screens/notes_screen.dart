...
class _NotesScreenState extends State<NotesScreen> {
                    ...
                    builder: (context) => Column(
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          onTap: () async {
                            Navigator.pop(context);
                            final targetFolder = await _showFolderSelectionDialog(note);
        ...
        if (children.isNotEmpty)
          Padding(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: children
                  .map((child) => _buildFolderTree(child))
                  .toList(),
            ),
          ),
      ],
  ...
  // 显示文件夹选择对话框
  Future<Folder?> _showFolderSelectionDialog(Note? note, {Folder? parentFolder}) async {
      ...
      builder: (context) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              _buildFolderTree(startFolder, isRoot: startFolder.id == 'root'),
            ],
          ),
        ),
        actions: [
