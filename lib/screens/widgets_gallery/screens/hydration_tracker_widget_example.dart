...
class _HydrationTrackerWidgetState extends State<HydrationTrackerWidget>
  ...
  double get remaining => (widget.goal - widget.consumed).clamp(0.0, widget.goal);
  ...
  @override
  void didUpdateWidget(HydrationTrackerWidget oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final primaryColor = _isBlueTheme(context)
