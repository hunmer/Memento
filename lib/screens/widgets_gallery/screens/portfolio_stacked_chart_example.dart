            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: PortfolioStackedChartWidget(
                    ...
                    assetTypes: const [
                      ...
                      AssetType(label: 'Funds', color: Color(0xFF2563EB)),
                      AssetType(label: 'Bonds', color: Color(0xFF000000)),
                      AssetType(label: 'ETFs', color: Color(0xFF4CAF50)),
                    ],
                    monthlyData: const [
                      MonthlyData(stocks: 48, funds: 32, bonds: 32),
                      MonthlyData(stocks: 40, funds: 28, bonds: 36),
                      ...
                      MonthlyData(stocks: 12, funds: 36, bonds: 28),
                      MonthlyData(stocks: 24, funds: 8, bonds: 28),
                      MonthlyData(stocks: 35, funds: 25, bonds: 30),
                    ],
                    monthLabels: const ['May', 'Jul', 'Oct', 'Dec', 'Jan', 'Mar', 'Apr', 'Jun'],
                  ),
                ),
                const SizedBox(height: 24),
                ...
                SizedBox(
                  ...
                  height: 400,
                  child: PortfolioStackedChartWidget(
                    title: 'Portfolio Overview and Analysis',
                    totalAmount: 231471.24,
                    growthPercentage: 12,
                    assetTypes: const [
                      AssetType(label: 'Stocks', color: Color(0xFF94B8FF)),
                      ...
                      AssetType(label: 'Bonds', color: Color(0xFF000000)),
                      AssetType(label: 'ETFs', color: Color(0xFF4CAF50)),
                      AssetType(label: 'Crypto', color: Color(0xFFFF9800)),
                    ],
                    monthlyData: const [
                      MonthlyData(stocks: 48, funds: 32, bonds: 32),
                      MonthlyData(stocks: 40, funds: 28, bonds: 36),
                      ...
                      MonthlyData(stocks: 24, funds: 8, bonds: 28),
                      MonthlyData(stocks: 35, funds: 25, bonds: 30),
                      MonthlyData(stocks: 42, funds: 22, bonds: 26),
                      MonthlyData(stocks: 38, funds: 28, bonds: 24),
                    ],
                    monthLabels: const ['May', 'Jul', 'Oct', 'Dec', 'Jan', 'Mar', 'Apr', 'Jun', 'Aug', 'Sep'],
                  ),
                ),
              ],
            ),
