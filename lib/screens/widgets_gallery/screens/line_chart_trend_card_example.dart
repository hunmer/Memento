...
class LineChartTrendCardWidget extends StatefulWidget {
  ...
  @override
  State<LineChartTrendCardWidget> createState() => _LineChartTrendCardWidgetState();
}
...
class _LineChartTrendCardWidgetState extends State<LineChartTrendCardWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final secondaryTextColor = isDark ? const Color(0xFF6B7280) : const Color(0xFF9CA3AF);
  ...
  Widget _buildHeader(Color textColor, Color secondaryTextColor, Color primaryColor, Color axisColor) {
...
class _LineChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (maxIndex < points.length - 1) {
      ...
      final partialX = currentPoint.dx + (nextPoint.dx - currentPoint.dx) * partialProgress;
      final partialY = currentPoint.dy + (nextPoint.dy - currentPoint.dy) * partialProgress;
