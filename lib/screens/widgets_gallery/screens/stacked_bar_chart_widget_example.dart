...
class _StackedBarChartWidgetState extends State<StackedBarChartWidget>
  ...
  Widget build(BuildContext context) {
    ...
    // 条形图颜色
    final barLightColor = isDark ? const Color(0xFFBAE6FD) : const Color(0xFFCCEFF9);
    final barMidColor = isDark ? const Color(0xFF0284C7) : const Color(0xFF0064A7);
    final barDarkColor = isDark ? const Color(0xFF0C4A6E) : const Color(0xFF000045);
                          ...
                          return Expanded(
                            child: Padding(
                              ...
                              child: _StackedBar(
                                ...
                                lightColor: barLightColor,
                                midColor: barMidColor,
