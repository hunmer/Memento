...
class EarningsTrendCardWidget extends StatefulWidget {
  ...
  @override
  State<EarningsTrendCardWidget> createState() => _EarningsTrendCardWidgetState();
}
...
class _EarningsTrendCardWidgetState extends State<EarningsTrendCardWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final iconBgColor = isDark ? const Color(0xFF374151) : const Color(0xFFF8FAFC);
    final iconColor = isDark ? const Color(0xFF38BDF8) : const Color(0xFF085F6D);
...
class _BarChartIcon extends StatelessWidget {
  ...
  const _BarChartIcon({required this.color});
